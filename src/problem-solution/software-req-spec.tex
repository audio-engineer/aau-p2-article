...
\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{%
        \begin{tabular}{ccc}
            \toprule
            \textbf{Requirement}                     & \textbf{MoSCoW category} & \textbf{Motivation}
            \\ \midrule
            Basic chess functionality                & Mo                       & {\ul~\ref{sec:chess}}
            \\ \midrule
            Online multiplayer functionality         & Mo                       & {\ul~\ref{sec:multiplayer-analysis}}
            \\ \midrule
            Applied learning principles              & Mo                       &
                {\ul~\ref{sec:learning-methods-for-chess}}             \\ \midrule
            Chess engine implementation              & Mo                       & {\ul~\ref{subsec:chess-engines}}
            \\ \midrule
            User accounts                            & S                        & {\ul~\ref{sec:multiplayer-analysis}}
            \\ \midrule
            User registration and authentication     & S                        & {\ul~\ref{sec:multiplayer-analysis}}
            \\ \midrule
            Engine feedback in English               & S                        & {\ul~\ref{subsec:chess-engines}}
            \\ \midrule
            Chat functionality                       & S                        &
                {\ul~\ref{subsec:effects-multiplayer-has-on-learning}} \\ \midrule
            Game listing                             & S                        & {\ul~\ref{sec:multiplayer-analysis}}
            \\ \midrule
            Analysis tool for post game analysis     & Co                       & {\ul~\ref{subsec:chess-engines}}
            \\ \midrule
