...
Another implementation that is not prioritized due to time constraints is the front-end implementation of the
´analyze\_move' function mentioned in Section~\ref{subsec:stockfish-image-functions}.
