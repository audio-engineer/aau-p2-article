\section{Relevance of chess}\label{sec:relevance-of-chess}
...
\begin{figure}
    ...
    \caption{The Google Trends result for the keyword \textcquote{google-trends2024}{chess}
...
As The New York Times writes:~\textcquote{nyt2022}{From October 2020 to April 2022,~\url{Chess.com} saw their number of
...
Chess as an online game presents itself as a new business market with a lot of
...
Most notably~\textcquote{business-insider2021}{the e-sports team TSM signed the five-time US chess champion and streamer
Hikaru Nakamura}.
